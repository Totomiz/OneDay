package com.zt.android.oneday.widget.avi;
...
import com.zt.android.oneday.widget.avi.indicators.BallPulseIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        String indicatorName=a.getString(R.styleable.GeoLoadingIndicatorView_indicatorName);
